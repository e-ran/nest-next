...
let RenderModule = RenderModule_1 = class RenderModule {
                ...
                providers: [
                    {
                        ...
                        useFactory: (nestHost) => {
                            return render_service_1.RenderService.init(options, next.getRequestHandler(), next.render.bind(next), next.renderError.bind(next), nestHost.httpAdapter);
                        },
                    },
                    {
                        ...
                        useFactory: (nestConfig, service) => {
                            const filter = new render_filter_1.RenderFilter(service, nestConfig);
    ...
    register(_app, next, options = {}) {
        ...
        if (!this.service.isInitialized()) {
            ...
            this.applicationConfig.useGlobalFilters(new render_filter_1.RenderFilter(this.service, this.applicationConfig));
        }
    }
};
